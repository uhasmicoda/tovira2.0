...
public class CreatePatientByDoctorTest extends BaseClass {
	@Test(groups = "smoke")
	public void createPatientByDoctorTest() throws InterruptedException, EncryptedDocumentException, IOException {
